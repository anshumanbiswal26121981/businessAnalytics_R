...
write.csv(topic1ToTopic2,file=paste("LDAGibbs",k,"Amazon_Topic1ToTopic2.csv")) #save it for complete analysis
t23df=as.data.frame(topic2ToTopic3)
t23df[1,1:6]# To check its contents
write.csv(topic2ToTopic3,file=paste("LDAGibbs",k,"Amazon_Topic2ToTopic3.csv")) #save it for complete analysis
