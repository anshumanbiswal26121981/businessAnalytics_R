...
amazon_combined.corpus.ptd <- tm_map(amazon_combined.corpus, PlainTextDocument)
tdm<- TermDocumentMatrix(amazon_combined.corpus.ptd, control= list(wordLengths= c(1, Inf)))
